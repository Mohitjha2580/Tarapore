...
export declare class CacheService {
    ...
    static setJSON(key: string, value: any, ttl?: number): Promise<boolean>;
    static getJSON<T>(key: string): Promise<T | null>;
    static setSession(sessionId: string, sessionData: any, ttl?: number): Promise<boolean>;
    static getSession<T>(sessionId: string): Promise<T | null>;
    static deleteSession(sessionId: string): Promise<boolean>;
    static incrementRateLimit(key: string, window: number): Promise<number>;
    static cacheLeaderboard(timeframe: string, data: any, ttl?: number): Promise<boolean>;
    static getLeaderboard<T>(timeframe: string): Promise<T | null>;
}
